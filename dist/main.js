...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js?sourceMap!./src/_noir.scss":
/*!*************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/resolve-url-loader!./node_modules/sass-loader/dist/cjs.js?sourceMap!./src/_noir.scss ***!
  \*************************************************************************************************************************************************/
...
const MovieInfo = function(sel) {
    var that = this;
    var obj = jquery__WEBPACK_IMPORTED_MODULE_0___default()(sel);
    if(obj.length === 0) {
        return;
    }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
        ...
        success: function(data) {
            ...
            if(results.charAt(results.length-1) != 0) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.getElementsByClassName("paper").item(0)).html("<p>No information" +
                    " available</p>");
        ...
        error: function(xhr, status, error) {
            // Error
            console.log(error);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.getElementsByClassName("paper").item(0)).html("<p>Unable to " +
...
MovieInfo.prototype.fillInfo = function(title, release, avg, count, plot, posterURL) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.getElementsByClassName("paper").item(0)).html(html);
};
...
MovieInfo.prototype.displayTab = function() {
    ...
    // Display Info tab
    var page = jquery__WEBPACK_IMPORTED_MODULE_0___default()("ul > li:first-child");
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("ul > li > a").click(function(event) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().siblings().children("div").fadeOut(1000);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().siblings().children("a").children("img").css("opacity", "0.3");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().children("div").fadeIn(1000);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().children("a").children("img").css("opacity", "1.0");
    });
...
Stars.prototype.message = function(message) {
    var that = this;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.getElementsByClassName("message").item(0)).html(message).show().delay(2000).fadeOut(1000);
};

Stars.prototype.updateTable = function(html) {
  var that = this;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.getElementsByClassName("table")).html(html);
...
var content = __webpack_require__(/*! !../node_modules/css-loader/dist/cjs.js!../node_modules/resolve-url-loader!../node_modules/sass-loader/dist/cjs.js?sourceMap!./_noir.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js?sourceMap!./src/_noir.scss");
...
/* harmony import */ var _MovieInfo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MovieInfo */ "./src/MovieInfo.js");
...
jquery__WEBPACK_IMPORTED_MODULE_4___default()(document).ready(function() {
    ...
    new _MovieInfo__WEBPACK_IMPORTED_MODULE_3__["MovieInfo"]('#info');
